...
cv2.moveWindow("OBB Demo", 0, 0)
cv2.moveWindow("Robot Controller", 1380, 0)
...
while True:
    ...
    #Something Selected
        ...
        if gt is None:
            ...
            robot_lines = [
                "========== CAMERA ==========",
                f"X : {gt.camera_x_mm:.1f}",
                f"Y : {gt.camera_y_mm:.1f}",
                f"Z : {gt.camera_z_mm:.1f}",
                "",
                "========== BOOK ==========",
                f"Book X : {gt.book_x_mm:.1f}",
                f"Book Y : {gt.book_y_mm:.1f}",
                f"Book Z : {gt.book_z_mm:.1f}",
                "",
                "========== GRASP ==========",
                f"Grasp X : {gt.grasp_x_mm:.1f}",
                f"Grasp Y : {gt.grasp_y_mm:.1f}",
                f"Grasp Z : {gt.grasp_z_mm:.1f}",
                "",
                "========== APPROACH ==========",
                f"Approach X : {gt.approach_x_mm:.1f}",
                f"Approach Y : {gt.approach_y_mm:.1f}",
                f"Approach Z : {gt.approach_z_mm:.1f}",
                "",
            ...
            robot_lines.extend([
                "",
                "========== ROBOT ==========",
                f"State    : {simulator.state_name[simulator.robot_state]}",
                f"Gripper  : {'OPEN' if simulator.robot.gripper_open else 'CLOSED'}",
                f"Book      : {simulator.book_state}",
                "",
                "========== IK ==========",
